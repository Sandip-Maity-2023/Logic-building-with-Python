...
import streamlit.components.v1 as components #importing the v1 version of the components module from Streamlit
import warnings
...
diabetes_df = pd.read_csv('E:\python file\diabetes.csv')
...
def app():
    ...
    img = Image.open(r"E:\python file\img.jpeg")
